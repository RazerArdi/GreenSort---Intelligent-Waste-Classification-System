...
│       └── reprocessing_metadata.json      # Metadata for pricing model preprocessing
├── notebooks/
...
- Save the models to `../models/ComputerVision/greensort_model.h5` and `../models/PriceEst/greensort_price_model_tf.h5`.
